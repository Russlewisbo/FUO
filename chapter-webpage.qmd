...
![A page from Akhawayni's *Hidāyat al-Muta'allimīn fī al-Tibb* (The Student's Handbook of Medicine), one of the earliest systematic recordings of fever curves.](images/persian.png){fig-align="center" width="400"}
...
![*Febris*, the Roman goddess of fever, worshipped by Romans living near the malarial marshes of Campagna.](images/febris.png){fig-align="center" width="300"}
:::
...
![A typical thermoscope design — a tube in which liquid rises and falls as temperature changes. The Sanctorius thermoscope was an early attempt to quantify body heat. (Prof. Francis Ring, University of Leeds)](images/thermometer.png){fig-align="center" width="500"}
...
![Carl Wunderlich's systematic temperature recordings in thousands of patients established 37°C as the standard for normal body temperature — a value since revised downward by modern studies.](images/wunderlink.png){fig-align="center" width="500"}
...
![Overview of the thermoregulatory system. The hypothalamus acts as the body's thermostat, integrating peripheral and central temperature signals and activating appropriate heat-generating or heat-dissipating responses to defend the set point.](images/thermoregulation.png){fig-align="center" width="700"}
...
![The febrile cascade: LPS and other PAMPs activate macrophages to release pyrogenic cytokines (IL-1, TNF-α, IL-6), which stimulate PGE₂ synthesis in the hypothalamus and reset the thermoregulatory set point upward. [@wright_auwaerter20]](images/LPSfever.png){fig-align="center" width="600"}
...
![Frequency of the five main etiologic categories of FUO across different patient age groups. Infectious causes decrease in patients above 65 years of age, while noninfectious inflammatory diseases become relatively more prominent.](images/FUOcat.png){fig-align="center" width="700"}
...
![Key infectious and inflammatory causes of FUO in infants and children. Joint involvement in a febrile child should always raise concern for endocarditis, leukemia, or connective tissue disease.](images/peds.png){fig-align="center" width="500"}
...
![In elderly patients with FUO, temporal arteritis and other connective tissue diseases predominate over infections in developed countries. Temporal arteritis is a medical emergency — early treatment with corticosteroids can prevent permanent vision loss.](images/elderly.png){fig-align="center" width="450"}
...
![Common causes of fever in ICU patients. Early fevers are often non-infectious and associated with good prognosis; prolonged fever carries a poorer prognosis and warrants active investigation.](images/icu.png){fig-align="center" width="500"}
...
![The spectrum of infections in immunocompromised hosts varies by the type and degree of immunodeficiency. Understanding the specific immune defect is critical for generating an appropriate differential diagnosis.](images/immunocomp.png){fig-align="center" width="650"}
...
![**Continuous/sustained fever pattern.** Temperature remains elevated with variation of less than 2°C. Associated with lobar pneumonia, rickettsiosis, typhoid fever, CNS disorders, tularemia, and falciparum malaria. [@mackowiak_etal97a]](images/continuous.png){fig-align="center" width="550"}
...
![**Intermittent (quotidian) fever pattern.** Wide daily fluctuations with temperature peaking between 4–8 PM. A double quotidian pattern (two daily spikes) is seen in salmonellosis, miliary tuberculosis, and gonococcal/meningococcal endocarditis. [@mackowiak_etal97a]](images/intermittent.png){fig-align="center" width="550"}

![**Malaria — paroxysmal fever patterns.** Febrile paroxysms occur every other day in *P. vivax*, *P. ovale*, and *P. falciparum* (tertian fever), and every third day in *P. malariae* (quartan fever). Regular cyclic fever is more common in *P. vivax* or *P. ovale* than *P. falciparum*.](images/malariafever.png){fig-align="center" width="600"}
...
![**Saddle-back (biphasic) fever pattern.** Several days of fever, followed by a distinct period of near-defervescence (~1 day), then recurrence with a second febrile phase. Classic for dengue, yellow fever, Colorado tick fever, and influenza. [@mackowiak_etal97a]](images/biphasic.png){fig-align="center" width="550"}
...
![**Undulating (Pel-Ebstein) fever pattern.** Weekly or longer cycles of fever alternating with equally long afebrile periods. Classically associated with Hodgkin's disease and brucellosis due to *Brucella melitensis*. [@mackowiak_etal97a]](images/Pelebstein.png){fig-align="center" width="550"}
...
![***Typus inversus* fever pattern.** Reversal of the normal diurnal rhythm, with the highest temperatures occurring in the early morning hours rather than the late afternoon. Described in miliary TB, salmonellosis, hepatic abscess, and bacterial endocarditis. [@mackowiak_etal97a]](images/typhus_inversus.png){fig-align="center" width="550"}

![**Typhoid (enteric) fever — step-ladder pattern.** Progressively higher daily fever over 3–4 days until reaching a plateau. Note the relative bradycardia, a suggestive clinical sign of typhoid fever.](images/typhoidfever.png){fig-align="center" width="600"}
...
![**Jarisch-Herxheimer reaction.** Sharply increased fever with rigors occurring within hours of initiating antibiotic therapy for spirochetal infections (syphilis, leptospirosis, relapsing fever). Reflects endotoxin release from organism lysis; does not indicate treatment failure.](images/jarisch.png){fig-align="center" width="500"}

![**Hectic (Charcot's) intermittent fever.** Sporadic fever episodes with periods of normal temperature in between. Frequently seen in cholangitis associated with cholelithiasis — the classic Charcot's triad is jaundice, fever, and right upper quadrant pain. [@mackowiak_etal97a]](images/recurrent.png){fig-align="center" width="550"}
...
![Bone marrow biopsy has a diagnostic yield of approximately 25% in FUO, and is particularly valuable for granulomatous infections (TB, histoplasmosis), hematologic malignancies, and patients with unexplained cytopenias.](images/bm_bx.png){fig-align="center" width="400"}
...
![CT imaging is the single most important imaging modality in FUO evaluation. CT abdomen/pelvis, chest, and pulmonary angiography are commonly used; MRI excels for CNS, vascular, and soft tissue pathology.](images/ct.png){fig-align="center" width="550"}
...
![¹⁸F-FDG PET/CT has revolutionized FUO diagnosis, with sensitivities of 86–98% and specificities of 52–85%. It is particularly valuable for detecting abscesses, osteomyelitis, vasculitis, adult-onset Still disease, and sites for targeted biopsy. [@kouijzer_etal18]](images/pet2.png){fig-align="center" width="600"}
...
![Diagnostic summary and approach to fever of unknown origin. A stepwise, history-guided evaluation is the foundation of efficient FUO workup. [@wright_auwaerter20]](images/clinicalsigns.jpeg){fig-align="center" width="700"}
