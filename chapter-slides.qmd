...
![](images/febris.png){fig-align="center"}
...
::: {.column width="50%"}
![<center> Dr. Carl Wunderlink </center>](images/wunderlink.png){fig-align="center" width="600"}
:::
:::::
...
::: notes
One striking observation is the steady decline in infectious causes of FUO since the mid-1990s, with a corresponding rise in cases of non-infectious inflammatory disease (NIID) and undiagnosed fever. This likely reflects improved diagnostic capacity and earlier diagnosis of common infections. It also underscores that empiric antimicrobial therapy without diagnosis is increasingly less likely to resolve FUO.
:::
...
![](images/misc.jpeg){fig-align="center"}
...
::: notes
In pediatric FUO, keeping a lower threshold for echocardiography in any child with fever and joint symptoms is prudent, as endocarditis can present atypically in children compared to adults.
:::
...
-   **Infections still important:**
    ...
    -   Endocarditis (prosthetic valves common in elderly)
...
::: incremental
-   **Leading causes:**
    -   Drug fever (especially to antibiotics, seizure meds)
...
::: notes
In the pre-HAART era, mycobacterial infections (TB and MAC) were leading causes of FUO in HIV-positive patients with CD4 \<50. Now with effective antiretroviral therapy, the spectrum has changed, though tuberculosis remains a leading cause globally. CMV and fungal infections like histoplasmosis and coccidioidomycosis (in endemic regions) also featured prominently.
:::
