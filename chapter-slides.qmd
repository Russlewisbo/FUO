...
:::: columns
::: {.column width="50%"}
![](images/clipboard-4236662536.png)
:::

::: {.column width="50%"}
PET-CT has revolutionized the diagnostic approach to FUO. Overall sensitivities range from 86-98% and specificity from 52-85%, depending on the etiology. It is particularly useful for detecting focal sites of infection or inflammation that might be missed on conventional imaging [@dekleijn_etal97; @wright_etal21].
:::
...
![](images/pet2.png){fig-align="center" width="800"}
